import 'package:alto_minho_mobilidade/ui/radio_selector/radio_button.dart';
import 'package:alto_minho_mobilidade/ui/radio_selector/radio_button_builder.dart';
import 'package:alto_minho_mobilidade/ui/radio_selector/radio_button_text_position.dart';
...
class RadioGroup<T> extends StatelessWidget {
  ...
  List<Widget> get _group =>
      this.items.map(
            (item) {
          final radioButtonBuilder = this.itemBuilder(item);

          return Container(
            height: this.direction == Axis.vertical
                ? this.spacebetween
                : 40.0,
            child: RadioButton(
